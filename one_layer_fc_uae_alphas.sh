...
python -m src.papers.compressibility_adv_robustness.run_mnist_one_layer_alpha_sweep --config configs/papers/compressibility_adv_robustness/mnist_one_layer_fcn.yaml --n-alphas 10 --alpha-min 1e-4 --alpha-max 3e-1 --seeds 0
